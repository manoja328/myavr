...
/*
 DDRB &= ~(_BV(PORTB1)); // Make Port B1 input 
 PORTB |= _BV(PORTB1); // Enable pull-up on Port B1  
 nstatus = PINB & _BV(PORTB1); // read switch, active low!
 PORTB &= ~(_BV(PORTB1)); // disable pull-up 
 */
